...
define("CATEGORIA_PRODUCTO_THUMB_WIDTH", 69);
define("CATEGORIA_PRODUCTO_THUMB_HEIGHT", 110);
...
define("PRODUCTO_PREVIEW_WIDTH", 100);
define("PRODUCTO_PREVIEW_HEIGHT", 126);
define("PRODUCTO_THUMB_WIDTH", 69);
define("PRODUCTO_THUMB_HEIGHT", 110);
