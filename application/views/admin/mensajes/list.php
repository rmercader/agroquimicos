  ...
  <div class="row">
    <div class="span12 columns">
      <div class="well">
        ...
        $options_mensajes = array('id_mensaje' => 'Id', 'fecha' => 'Fecha', 'nombre' => 'Nombre', 'visto' => 'Visto');
      ...
      <table class="table table-striped table-bordered table-condensed">
        <thead>
          <tr>
            ...
            <th class="yellow header headerSortDown">Visto</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          {
            $styleTd = $row['visto'] ? '' : 'style="font-weight: bold"';
            echo '<tr>';
            echo "<td $styleTd>".$row['id_mensaje'].'</td>';
            echo "<td $styleTd>".date_format(new DateTime($row['fecha']), 'd/m/Y H:i').'</td>';
            echo "<td $styleTd>".$row['nombre'].'</td>';
            echo "<td $styleTd>".$row['email'].'</td>';
            echo "<td $styleTd>".($row['visto'] ? 'Si' : 'No').'</td>';
