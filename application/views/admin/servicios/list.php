  ...
  <div class="row">
    <div class="span12 columns">
      <div class="well">
        ...
        $options_servicios = array('id_servicio' => 'Id', 'nombre_esp' => 'Nombre');

        echo form_open('admin/servicios', $attributes);
 
          echo form_label('Buscar:', 'search_string');
          echo form_input('search_string', $search_string_selected);

          echo form_label('Ordenar por:', 'order');
          echo form_dropdown('order', $options_servicios, $order, 'class="span2"');
          echo "&nbsp;";
        ...
        <tbody>
          ...
          foreach($servicios as $row)
          {
            ...
            echo '<td class="crud-actions">
              <a href="'.site_url("admin").'/servicios/update/'.$row['id_servicio'].'" class="btn btn-info">Ver & editar</a>  
              <a href="'.site_url("admin").'/servicios/delete/'.$row['id_servicio'].'" class="btn btn-danger">Eliminar</a>
            </td>';
            echo '</tr>';
          }
          ?>      
